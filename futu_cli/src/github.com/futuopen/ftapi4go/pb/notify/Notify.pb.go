...
const (
	...
	NotifyType_NotifyType_APIQuota      NotifyType = 6
)
...
type APIQuota struct {
	SubQuota       int32 `protobuf:"varint,1,req,name=subQuota" json:"subQuota"`
	HistoryKLQuota int32 `protobuf:"varint,2,req,name=historyKLQuota" json:"historyKLQuota"`
}

func (m *APIQuota) Reset()         { *m = APIQuota{} }
func (m *APIQuota) String() string { return proto.CompactTextString(m) }
func (*APIQuota) ProtoMessage()    {}
func (*APIQuota) Descriptor() ([]byte, []int) {
	return fileDescriptor_cb08ef5f3e7048c1, []int{5}
}
func (m *APIQuota) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *APIQuota) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_APIQuota.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *APIQuota) XXX_Merge(src proto.Message) {
	xxx_messageInfo_APIQuota.Merge(m, src)
}
func (m *APIQuota) XXX_Size() int {
	return m.Size()
}
func (m *APIQuota) XXX_DiscardUnknown() {
	xxx_messageInfo_APIQuota.DiscardUnknown(m)
}

var xxx_messageInfo_APIQuota proto.InternalMessageInfo

func (m *APIQuota) GetSubQuota() int32 {
	if m != nil {
		return m.SubQuota
	}
	return 0
...
func (m *APIQuota) GetHistoryKLQuota() int32 {
	if m != nil {
		return m.HistoryKLQuota
	}
	return 0
}
...
type S2C struct {
	...
	ApiQuota      *APIQuota      `protobuf:"bytes,7,opt,name=apiQuota" json:"apiQuota,omitempty"`
}
...
func (m *S2C) GetApiQuota() *APIQuota {
	if m != nil {
		return m.ApiQuota
	}
	return nil
...
func (*Response) Descriptor() ([]byte, []int) {
	return fileDescriptor_cb08ef5f3e7048c1, []int{7}
}
...
func init() {
	...
	proto.RegisterType((*APIQuota)(nil), "Notify.APIQuota")
...
var fileDescriptor_cb08ef5f3e7048c1 = []byte{
	...
	,
}
...
func (m *APIQuota) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *APIQuota) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *APIQuota) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	i = encodeVarintNotify(dAtA, i, uint64(m.HistoryKLQuota))
	i--
	dAtA[i] = 0x10
	i = encodeVarintNotify(dAtA, i, uint64(m.SubQuota))
	i--
	dAtA[i] = 0x8
	return len(dAtA) - i, nil
}
...
func (m *S2C) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.ApiQuota != nil {
		{
			size, err := m.ApiQuota.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *APIQuota) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	n += 1 + sovNotify(uint64(m.SubQuota))
	n += 1 + sovNotify(uint64(m.HistoryKLQuota))
	return n
}
...
func (m *APIQuota) Unmarshal(dAtA []byte) error {
	var hasFields [1]uint64
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: APIQuota: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: APIQuota: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field SubQuota", wireType)
			}
			m.SubQuota = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
		...
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field HistoryKLQuota", wireType)
			}
			m.HistoryKLQuota = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.HistoryKLQuota |= int32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
	...
	if hasFields[0]&uint64(0x00000001) == 0 {
		return github_com_gogo_protobuf_proto.NewRequiredNotSetError("subQuota")
	}
	if hasFields[0]&uint64(0x00000002) == 0 {
		return github_com_gogo_protobuf_proto.NewRequiredNotSetError("historyKLQuota")
	}
...
func (m *S2C) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			...
			if err := m.ApiQuota.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
