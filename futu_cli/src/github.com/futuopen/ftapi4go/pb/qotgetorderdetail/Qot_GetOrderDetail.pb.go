...
var fileDescriptor_9136f364d33d18c8 = []byte{
	...
	,
}
...
func (m *C2S) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.Security == nil {
	...
	} else {
		{
			...
			i -= size
			i = encodeVarintQot_GetOrderDetail(dAtA, i, uint64(size))
		}
		i--
		dAtA[i] = 0xa
	}
...
func (m *Response) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	i = encodeVarintQot_GetOrderDetail(dAtA, i, uint64(m.ErrCode))
	i--
	dAtA[i] = 0x18
	i -= len(m.RetMsg)
	copy(dAtA[i:], m.RetMsg)
	i = encodeVarintQot_GetOrderDetail(dAtA, i, uint64(len(m.RetMsg)))
	i--
	dAtA[i] = 0x12
	if m.RetType == nil {
		return 0, github_com_gogo_protobuf_proto.NewRequiredNotSetError("retType")
	} else {
		i = encodeVarintQot_GetOrderDetail(dAtA, i, uint64(*m.RetType))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func encodeVarintQot_GetOrderDetail(dAtA []byte, offset int, v uint64) int {
	offset -= sovQot_GetOrderDetail(v)
	base := offset
	for v >= 1<<7 {
...
func (m *C2S) Size() (n int) {
	...
	if m.Security != nil {
		l = m.Security.Size()
		n += 1 + l + sovQot_GetOrderDetail(uint64(l))
	}
	return n
}
...
func (m *Response) Size() (n int) {
	...
	_ = l
	if m.RetType != nil {
		n += 1 + sovQot_GetOrderDetail(uint64(*m.RetType))
	}
	l = len(m.RetMsg)
	n += 1 + l + sovQot_GetOrderDetail(uint64(l))
	n += 1 + sovQot_GetOrderDetail(uint64(m.ErrCode))
	if m.S2C != nil {
		l = m.S2C.Size()
		n += 1 + l + sovQot_GetOrderDetail(uint64(l))
	}
...
func sovQot_GetOrderDetail(x uint64) (n int) {
	return (math_bits.Len64(x|1) + 6) / 7
}
func sozQot_GetOrderDetail(x uint64) (n int) {
	return sovQot_GetOrderDetail(uint64((x << 1) ^ uint64((int64(x) >> 63))))
}
func (m *C2S) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		for shift := uint(0); ; shift += 7 {
			if shift >= 64 {
				return ErrIntOverflowQot_GetOrderDetail
			}
			if iNdEx >= l {
		...
		case 1:
			...
			if msglen < 0 {
				return ErrInvalidLengthQot_GetOrderDetail
			}
		...
		default:
			iNdEx = preIndex
			skippy, err := skipQot_GetOrderDetail(dAtA[iNdEx:])
			if err != nil {
				return err
			}
			if skippy < 0 {
...
func skipQot_GetOrderDetail(dAtA []byte) (n int, err error) {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		var wire uint64
		for shift := uint(0); ; shift += 7 {
			if shift >= 64 {
				return 0, ErrIntOverflowQot_GetOrderDetail
			}
			if iNdEx >= l {
		...
		case 2:
			...
			if length < 0 {
				return 0, ErrInvalidLengthQot_GetOrderDetail
			}
			iNdEx += length
			if iNdEx < 0 {
				return 0, ErrInvalidLengthQot_GetOrderDetail
		...
		case 3:
			for {
				...
				next, err := skipQot_GetOrderDetail(dAtA[start:])
				if err != nil {
					return 0, err
				}
				iNdEx = start + next
...
var (
	ErrInvalidLengthQot_GetOrderDetail = fmt.Errorf("proto: negative length found during unmarshaling")
	ErrIntOverflowQot_GetOrderDetail   = fmt.Errorf("proto: integer overflow")
)
