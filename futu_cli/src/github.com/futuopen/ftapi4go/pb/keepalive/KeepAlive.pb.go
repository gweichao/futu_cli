...
var fileDescriptor_b89598dfba3721fe = []byte{
	...
	,
}
...
func (m *Response) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	i = encodeVarintKeepAlive(dAtA, i, uint64(m.ErrCode))
	i--
	dAtA[i] = 0x18
	i -= len(m.RetMsg)
	copy(dAtA[i:], m.RetMsg)
	i = encodeVarintKeepAlive(dAtA, i, uint64(len(m.RetMsg)))
	i--
	dAtA[i] = 0x12
	if m.RetType == nil {
		return 0, github_com_gogo_protobuf_proto.NewRequiredNotSetError("retType")
	} else {
		i = encodeVarintKeepAlive(dAtA, i, uint64(*m.RetType))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *Response) Size() (n int) {
	...
	_ = l
	if m.RetType != nil {
		n += 1 + sovKeepAlive(uint64(*m.RetType))
	}
	l = len(m.RetMsg)
	n += 1 + l + sovKeepAlive(uint64(l))
	n += 1 + sovKeepAlive(uint64(m.ErrCode))
	if m.S2C != nil {
		l = m.S2C.Size()
		n += 1 + l + sovKeepAlive(uint64(l))
	}
