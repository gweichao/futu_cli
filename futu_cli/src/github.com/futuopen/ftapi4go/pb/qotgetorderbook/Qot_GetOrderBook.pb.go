...
var fileDescriptor_a611dcf89041d5af = []byte{
	...
	,
}
...
func (m *C2S) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	i = encodeVarintQot_GetOrderBook(dAtA, i, uint64(m.Num))
	i--
	dAtA[i] = 0x10
	if m.Security == nil {
	...
	} else {
		{
			...
			i -= size
			i = encodeVarintQot_GetOrderBook(dAtA, i, uint64(size))
		}
		i--
		dAtA[i] = 0xa
	}
...
func (m *S2C) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	i = encodeVarintQot_GetOrderBook(dAtA, i, uint64(len(m.SvrRecvTimeAsk)))
	i--
	dAtA[i] = 0x32
	i -= 8
	...
	i = encodeVarintQot_GetOrderBook(dAtA, i, uint64(len(m.SvrRecvTimeBid)))
	i--
	dAtA[i] = 0x22
...
func (m *Response) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	i = encodeVarintQot_GetOrderBook(dAtA, i, uint64(m.ErrCode))
	i--
	dAtA[i] = 0x18
	i -= len(m.RetMsg)
	copy(dAtA[i:], m.RetMsg)
	i = encodeVarintQot_GetOrderBook(dAtA, i, uint64(len(m.RetMsg)))
	i--
	dAtA[i] = 0x12
	if m.RetType == nil {
		return 0, github_com_gogo_protobuf_proto.NewRequiredNotSetError("retType")
	} else {
		i = encodeVarintQot_GetOrderBook(dAtA, i, uint64(*m.RetType))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func encodeVarintQot_GetOrderBook(dAtA []byte, offset int, v uint64) int {
	offset -= sovQot_GetOrderBook(v)
	base := offset
	for v >= 1<<7 {
...
func (m *C2S) Size() (n int) {
	...
	if m.Security != nil {
		l = m.Security.Size()
		n += 1 + l + sovQot_GetOrderBook(uint64(l))
	}
	n += 1 + sovQot_GetOrderBook(uint64(m.Num))
	return n
}
...
func (m *Response) Size() (n int) {
	...
	_ = l
	if m.RetType != nil {
		n += 1 + sovQot_GetOrderBook(uint64(*m.RetType))
	}
	l = len(m.RetMsg)
	n += 1 + l + sovQot_GetOrderBook(uint64(l))
	n += 1 + sovQot_GetOrderBook(uint64(m.ErrCode))
	if m.S2C != nil {
		l = m.S2C.Size()
		n += 1 + l + sovQot_GetOrderBook(uint64(l))
	}
...
func sovQot_GetOrderBook(x uint64) (n int) {
	return (math_bits.Len64(x|1) + 6) / 7
}
func sozQot_GetOrderBook(x uint64) (n int) {
	return sovQot_GetOrderBook(uint64((x << 1) ^ uint64((int64(x) >> 63))))
}
func (m *C2S) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		for shift := uint(0); ; shift += 7 {
			if shift >= 64 {
				return ErrIntOverflowQot_GetOrderBook
			}
			if iNdEx >= l {
		...
		case 1:
			...
			if msglen < 0 {
				return ErrInvalidLengthQot_GetOrderBook
			}
		...
		default:
			iNdEx = preIndex
			skippy, err := skipQot_GetOrderBook(dAtA[iNdEx:])
			if err != nil {
				return err
			}
			if skippy < 0 {
...
func skipQot_GetOrderBook(dAtA []byte) (n int, err error) {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		var wire uint64
		for shift := uint(0); ; shift += 7 {
			if shift >= 64 {
				return 0, ErrIntOverflowQot_GetOrderBook
			}
			if iNdEx >= l {
		...
		case 2:
			...
			if length < 0 {
				return 0, ErrInvalidLengthQot_GetOrderBook
			}
			iNdEx += length
			if iNdEx < 0 {
				return 0, ErrInvalidLengthQot_GetOrderBook
		...
		case 3:
			for {
				...
				next, err := skipQot_GetOrderBook(dAtA[start:])
				if err != nil {
					return 0, err
				}
				iNdEx = start + next
...
var (
	ErrInvalidLengthQot_GetOrderBook = fmt.Errorf("proto: negative length found during unmarshaling")
	ErrIntOverflowQot_GetOrderBook   = fmt.Errorf("proto: integer overflow")
)
